 ...
 * Expression parser.
 * <p>
 * Compiles expressions into byte code. Expressions consist of literals, variable names, binary
 * operations {@code +, -, *, /, ^}, unary operations {@code -x, |x|, \x}, function calls
 * {@code sqrt(x)}, {@code root(x, n)} and {@code pow(x, n)}, and parentheses to control precedence
 * </p>
 * <p>
 ...
 * @since July 2017
 */
public final class Compiler<P extends Parsable<P>>
{
