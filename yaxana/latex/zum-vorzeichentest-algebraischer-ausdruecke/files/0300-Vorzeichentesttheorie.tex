...
wären hingegen Nullstellenpaare mit $|z_{k_0}\cdot z_{k_1}|=1$,
 ...
 man denke etwa an $N^{\rm th}$ band filter (siehe \refappendix{se:AnhangFilter})
...
geteilt wird.
Man erhält einerseits Nullstellen $\left|\frac{z_{k}}{z_{k}}\right|=1$
und andererseits Nullstellenpaare
$\frac{z_{k}}{z_{m}}$ und $\frac{z_{m}}{z_{k}}$
mit $\left|\frac{z_{k}}{z_{m}}\frac{z_{m}}{z_{k}}\right|=1$.
\end{proof}
\end{theorem}
